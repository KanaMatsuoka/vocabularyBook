 ...
 if ($recordSet->num_rows > 0){
  ...
  $kind = array(
    ...
    if($category == $kind['kind']){
         echo "<td><a href='detail.php?id=$id'><span style='color: red;'>$english</span></a></td>";
  }elseif($category == $kind['kind2']) {

         echo "<td><a href='detail.php?id=$id'><span style='color: blue;'>$english</span></a></td>";
  }elseif($category == $kind['kind3']) {

         echo "<td><a href='detail.php?id=$id'><span style='color: green;'>$english</span></a></td>";
...
<br>
 ...
 if ($page > 1) { 
 ?>
 <a href="userhome.php?page=<?php print($page - 1); ?>"><img class="arrow" src="Project.css/arrowleft.jpg" width="45" height="45">
</a>
 <?php
 } else {
 ?>
 ...
 if ($page < $maxPage) { 
 ?>
 <a href="userhome.php?page=<?php print($page + 1); ?>"><img class="arrow" src="Project.css/arrow.jpg" width="45" height="45">
  </a>
 <?php
 } else {
 ?>
